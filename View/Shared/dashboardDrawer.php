    ...
    <div class="dashboard_container">
        <div class="dashboard_navlinks">
            ...
            <div id="menu" class="dashboard_quick_links">
                ...
                if (isset($_SESSION['role'])) {
                    if ($_SESSION['role'] == 'teacher') { ?>
                        <a class="<?= $page === 'addCourseContent.php' ? 'drawer_active' : 'drawer_nav_link'; ?>"
                            href="./../../../Project/View/Pages/addCourseContent.php">Add Course Content</a>
                ...
                if (isset($_SESSION['role'])) {
                    if ($_SESSION['role'] == 'admin') { ?>
                        <a class="<?= $page === 'addAdmin.php' ? 'drawer_active' : 'drawer_nav_link'; ?>"
                            href="./../../../Project/View/Pages/addAdmin.php">Add Admin</a>
